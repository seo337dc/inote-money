          ...
          return (
            <button
              ...
              className={cn(
                ...
                'flex flex-col transition-colors hover:bg-green-50/50 dark:hover:bg-green-900/20 focus:outline-none'
              )}
            >
              <span
                className={cn(
              ...
              {hasData && (
                <div className="flex gap-1 sm:hidden mt-auto">
                  ...
                  {waste > 0 && <span className="w-1.5 h-1.5 rounded-full bg-orange-400 shrink-0" />}
                </div>
              )}
            </button>
          );
