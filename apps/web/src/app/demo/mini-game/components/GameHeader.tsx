...
import { DollarSign, TrendingUp, Award, Wallet, Building2, RotateCcw } from 'lucide-react';
...
export function GameHeader({ player, onOpenBank, onOpenStatement, onResetGame }: GameHeaderProps) {
