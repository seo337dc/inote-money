...
export default function AccountBookPage() {
  ...
  return (
    <div className="max-w-7xl 2xl:max-w-screen-2xl mx-auto lg:px-8 2xl:px-12 pt-6 pb-4">
      ...
      {/* Mobile FAB — bottom-20 to clear mobile nav bar */}
      <button
        onClick={() => setSelectedDate(todayKey())}
        className="lg:hidden fixed bottom-20 right-5 w-14 h-14 bg-green-500 hover:bg-green-600 text-white rounded-full shadow-lg flex items-center justify-center text-3xl leading-none transition-colors active:scale-95 z-30"
        aria-label="오늘 지출 추가"
      >
        +
      </button>
