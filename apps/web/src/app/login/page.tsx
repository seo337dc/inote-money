...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center bg-background overflow-hidden">
      ...
      {popupOpen && (
        <div className="absolute inset-0 bg-white/85 z-10 flex flex-col items-center justify-center gap-4">
          ...
          <p className="text-sm font-medium text-gray-800">팝업창에서 계정을 선택해주세요</p>
        </div>
      )}
